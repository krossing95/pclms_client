...
const ClearHiddenEquipmentPermanently = () => {
    ...
    return (
        <Dialog open={app.hasOpenedPermanentDeletePrompt} PaperComponent={MovablePrompt} aria-labelledby="draggable-dialog-title">
            ...
            />
            <DialogContent>
                <Typography gutterBottom variant='body2'>{"Deleting these records carries the risk of losing associated records in history. Do you want to continue?"}</Typography>
